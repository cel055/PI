<?php
    ...
    mail("cel055ufsc@gmail","$assunto",$msg,$header);
    mail("herbert.sprengel@gmail.com","$assunto",$msg,$header);

    $header = implode("\n",array("From: cel055ufsc@gmail.com", "Subject: Equipe PacMonster","Return-Path: cel055.ufsc@gmail.com","MIME-Version: 1.0", "X-Priority: 3","Coontent-Type: text/html; charset=UTF-8"));
